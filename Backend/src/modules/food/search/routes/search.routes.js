...
import { searchController, searchProductsController, listAdminCategoriesController, resolveStoreFromLocationHeaders } from '../controllers/search.controller.js';
 ...
 */
router.get('/products', resolveStoreFromLocationHeaders, cacheResponse(30, 'search_products', { browserTtlSeconds: 10 }), searchProductsController);
