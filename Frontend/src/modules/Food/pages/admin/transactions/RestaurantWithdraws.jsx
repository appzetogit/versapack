              ...
              <table className="w-full">
                <thead className="bg-slate-50 border-b border-slate-200">
                  <tr>
                    ...
                    {visibleColumns.restaurant && <th className="px-6 py-4 text-left text-[10px] font-bold text-slate-700 uppercase tracking-wider">Seller Name</th>}
                    {visibleColumns.restaurantId && <th className="px-6 py-4 text-left text-[10px] font-bold text-slate-700 uppercase tracking-wider">Seller ID</th>}
          ...
          <DialogContent className="max-w-md bg-white p-0">
            ...
            {selectedWithdraw && (
              <div className="px-6 pb-6 space-y-4">
                ...
                <div>
                  <label className="text-xs font-semibold text-slate-500 uppercase">Seller Name</label>
                  <p className="text-sm font-medium text-slate-900 mt-1">{selectedWithdraw.restaurantName || 'N/A'}</p>
                </div>
                <div>
                  <label className="text-xs font-semibold text-slate-500 uppercase">Seller ID</label>
