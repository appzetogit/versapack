  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: "Utensils",
        subItems: [
          { label: "Seller Products List", path: "/admin/food/products" },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        subItems: [
          { label: "Sellers List", path: "/admin/food/sellers" },
          { label: "New Seller Requests", path: "/admin/food/sellers/joining-request" },
          { label: "Unregistered Sellers", path: "/admin/food/sellers/unregistered" },
          { label: "Seller Reviews", path: "/admin/food/sellers/reviews" },
          { label: "Seller Complaints", path: "/admin/food/sellers/complaints" },
          { label: "Seller Settings", path: "/admin/food/sellers/settings" },
          { label: "Subscription Settings", path: "/admin/food/sellers/subscription-settings" },
          { label: "Subscription Billing", path: "/admin/food/sellers/subscription-history" },
        ],
      },
    ],
  },
