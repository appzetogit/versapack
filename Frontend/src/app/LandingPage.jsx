    ...
    async function fetchSupportInfo() {
      try {
        ...
        if (data && (data.email || data.mobile)) {
          setSupportContact({
            email: data.email || "support@versapack.com",
            ...
            <h1 className="text-[10vw] lg:text-[5.8vw] font-black leading-[0.85] tracking-tighter text-slate-900 relative z-20">
              ...
              <div className="overflow-hidden pb-4">
                <motion.div custom={2} initial="hidden" animate="visible" variants={textReveal} className="flex items-center gap-4 lg:gap-8">
                  <span className="text-transparent bg-clip-text bg-gradient-to-br from-[#FA0272] to-pink-600">VERSAPACK?</span>
                </motion.div>
              </div>
            </h1>
        ...
        <div className="max-w-[1800px] mx-auto px-6 md:px-16 lg:px-24 flex flex-col lg:flex-row items-center gap-20">
          ...
          <div className="flex-1 space-y-8 order-1 lg:order-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <a
                href="https://apps.apple.com/in/app/versapack/id6766444150"
                target="_blank"
              ...
              <a
                href="https://play.google.com/store/apps/details?id=com.versapack.user1"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-slate-600 font-light leading-relaxed">
                Starting our journey from the progressive landscape of <strong>Telangana</strong>, VersaPack is engineered to scale across India, specifically focusing on empowering Tier-2 and Tier-3 cities.
              </p>
            </div>
        ...
        <div className="max-w-[1800px] mx-auto">
          <div className="grid lg:grid-cols-5 gap-16 mb-24 relative z-10">
            <div className="lg:col-span-2">
              ...
              <div className="flex gap-4">
                {[
                  ...
                  { Icon: Youtube, url: "https://youtube.com/@versapack?si=EzceIs61zBwz3SGO" },
                  { Icon: Instagram, url: "https://www.instagram.com/versapack?igsh=MTA3eXJnMTRlMTF5Zw%3D%3D&utm_source=qr" },
                  { Icon: Linkedin, url: "https://www.linkedin.com/company/versapack/" }
                ].map(({ Icon, url }, i) => (
                  <a 
                    key={i} 
                    href={url} 
            ...
            <div className="flex flex-col gap-5 text-sm font-medium">
              ...
              <a 
                href="https://versapack.com/food/user/profile/privacy" 
                target="_blank" 
                rel="noopener noreferrer" 
              ...
              <a 
                href="https://versapack.com/food/user/profile/terms" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="hover:text-[#FA0272] transition-colors"
              >
            ...
            <div className="flex flex-col gap-5 text-sm font-medium">
              ...
              <a 
                href="https://versapack.com/food/user/profile/about" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="hover:text-[#FA0272] transition-colors"
              >
              ...
              <a 
                href="https://versapack.com/food/user/profile/help-content" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="hover:text-[#FA0272] transition-colors"
              >
        ...
        {isAboutOpen && (
          ...
          >
            ...
            <main className="flex-1 relative z-10 w-full max-w-[1400px] mx-auto px-6 py-12 md:py-20 lg:px-20 flex flex-col gap-12 md:gap-20">
              ...
              <div className="max-w-3xl space-y-6">
                ...
                <p className="text-xl text-slate-600 font-light leading-relaxed">
                  VersaPack is built with a mission to create a sustainable, transparent, and balanced environment for both food merchants and consumers across India.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 lg:gap-12 shrink-0">
                ...
                <div className="group bg-white border border-slate-200/60 rounded-[2rem] p-8 lg:p-10 hover:shadow-2xl hover:shadow-pink-500/5 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-slate-600 font-light leading-relaxed">
                      VersaPack is starting its journey from Telangana, with a strategic focus on expanding across Tier 2 and Tier 3 cities in India. We aim to empower local businesses in these growing regions and integrate them into the digital market.
                    </p>
                  </div>
                  <div className="mt-8 pt-6 border-t border-slate-100 flex items-center gap-3">
            ...
            <footer className="bg-slate-50 border-t border-slate-200/50 py-8 text-center text-xs text-slate-400 font-medium shrink-0">
              <p>© 2026 {APP_CONFIG?.NAME || "VersaPack"} Technologies Inc. All rights reserved.</p>
            </footer>
          </motion.div>
        )}
              ...
              <div className="bg-slate-900 text-white rounded-[2.5rem] p-8 md:p-14 relative overflow-hidden shadow-2xl shrink-0 flex flex-col lg:flex-row items-center gap-12 border border-slate-800">
                ...
                <div className="flex-1 space-y-6 relative z-10">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-2">
                    <a
                      href="https://apps.apple.com/in/app/versapack-partner/id6766466794"
                      target="_blank"
                      rel="noopener noreferrer"
                    ...
                    <a
                      href="https://play.google.com/store/apps/details?id=com.versapack.restaurant1"
                      target="_blank"
                      rel="noopener noreferrer"
                  ...
                  <div className="w-full max-w-[380px] h-[250px] bg-slate-900 border-4 border-slate-700 rounded-2xl shadow-2xl p-4 flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-2 gap-3 py-2 flex-1 items-center">
                      <div className="bg-slate-950 border border-slate-800 rounded-lg p-2.5 text-center">
                        <div className="text-[8px] text-slate-500 font-bold uppercase tracking-wider">With VersaPack</div>
              ...
              <div className="grid md:grid-cols-2 gap-8 lg:gap-12 shrink-0">
                ...
                <div className="group bg-white/80 border border-slate-200/40 rounded-[2rem] p-8 lg:p-10 hover:shadow-2xl hover:shadow-[#FA0272]/5 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between shadow-sm">
                  <div>
                    ...
                    <p className="text-slate-600 font-light leading-relaxed">
                      Say goodbye to frustrating weekly payout cycles that lock up your operating capital. VersaPack processes bank settlements daily, keeping your cash flow running smoothly.
                    </p>
                  </div>
                  <div className="mt-8 pt-6 border-t border-slate-200/50 flex items-center gap-3">
                ...
                {leadSuccess ? (
                  ...
                  >
                    ...
                    <p className="text-sm text-slate-600 max-w-md mx-auto">
                      Thank you for choosing VersaPack. Our onboarding representative will get in touch with you shortly to finalize your registration.
                    </p>
                    <button
            ...
            <main className="flex-1 relative z-10 w-full max-w-[1400px] mx-auto px-6 py-12 md:py-20 lg:px-20 flex flex-col gap-12 md:gap-20">
              ...
              <div className="max-w-4xl space-y-6 text-center mx-auto mb-4">
                ...
                <p className="text-xl text-slate-400 font-light leading-relaxed max-w-3xl mx-auto">
                  Join the elite squad of VersaPack Captains. Secure the most competitive distance-based payout structure, absolute route clarity, weekly settlements, and <strong>keep 100% of your customer tips</strong>.
                </p>
              </div>
              ...
              <div className="bg-slate-950 text-white rounded-[2.5rem] p-8 md:p-14 relative overflow-hidden shadow-2xl shrink-0 flex flex-col lg:flex-row items-center gap-12 border border-slate-900">
                ...
                <div className="flex-1 space-y-6 relative z-10">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-2">
                    <a
                      href="https://apps.apple.com/in/app/versapack-captain/id6766778164"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-3 bg-white text-slate-950 hover:bg-[#FA0272] hover:text-white px-8 py-4 rounded-2xl font-bold transition-all duration-300 text-sm shadow-md cursor-pointer text-center"
                    >
                    ...
                    <a
                      href="https://play.google.com/store/apps/details?id=com.versapack.delivery1"
                      target="_blank"
                      rel="noopener noreferrer"
              ...
              <div className="grid md:grid-cols-2 gap-8 lg:gap-12 shrink-0">
                ...
                <div className="group bg-slate-900/40 border border-slate-800/80 rounded-[2rem] p-8 lg:p-10 hover:shadow-2xl hover:shadow-pink-500/5 hover:border-pink-500/30 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-slate-400 font-light leading-relaxed">
                      Every single rupee that a grateful customer tips you belongs entirely to you. VersaPack takes zero cuts from your extra rewards. Honest payouts, guaranteed.
                    </p>
                  </div>
                ...
                <div className="group bg-slate-900/40 border border-slate-800/80 rounded-[2rem] p-8 lg:p-10 hover:shadow-2xl hover:shadow-pink-500/5 hover:border-pink-500/30 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-slate-400 font-light leading-relaxed">
                      Never wait weeks to enjoy your hard-earned rewards. VersaPack settles your total earnings straight into your active digital wallet every single week, cleanly and securely.
                    </p>
                  </div>
                  <div className="mt-8 pt-6 border-t border-slate-800/60 flex items-center gap-3">
                    <Map className="w-4 h-4 text-[#FA0272]" />
